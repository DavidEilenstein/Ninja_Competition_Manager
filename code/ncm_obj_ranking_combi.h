...
public:
    ...
    NCM_OBJ_Ranking_Challenge_List  rankings_challenges()                                   {return RankingsChallenges;}

    size_t                          quali_state(NCM_OBJ_Competitor competitor);
    size_t                          quali_from_challenge_index(NCM_OBJ_Competitor competitor);
...
private:
    ...
    vector<size_t>                  vQualiFromChallengeIndex;
